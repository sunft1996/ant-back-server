...
-- Records of article
-- ----------------------------
INSERT INTO `article` VALUES ('2', '如何新建一个列表页', '1', '新建页面', '<h3>步骤：</h3><h3>1. 添加页面文件（内容直接复制基础列表页，本地路径：/src/pages/Demo/List.js）；</h3><p><img src=\"http://back.1cloud.xyz/uploadImg/1589858923127_image.png\" style=\"max-width:100%;\"><span style=\"color: rgba(0, 0, 0, 0.65); font-size: 14px;\"><br></span></p><h3>2. 在前端路由配置文件中添加路由（ 本地路径：/config/router.config.js&nbsp; ）；</h3><p><span style=\"color: rgba(0, 0, 0, 0.65); font-size: 14px;\"><br></span></p><p><img src=\"http://back.1cloud.xyz/uploadImg/1588831306668_image.png\" style=\"max-width:100%;\"><span style=\"color: rgba(0, 0, 0, 0.65); font-size: 14px;\"><br></span></p><p><span style=\"color: rgba(0, 0, 0, 0.65); font-size: 14px;\"><br></span></p><h3>3. 菜单管理页面：添加菜单（菜单URL需要与路由配置中的path一致）；&nbsp;&nbsp;<br></h3><p><br></p><p><img src=\"http://back.1cloud.xyz/uploadImg/1588821941286_image.png\" style=\"color: rgba(0, 0, 0, 0.65); font-size: 14px; max-width: 100%;\"></p><p><br></p><h3><p>4. 角色管理页面：给角色分配菜单权限；</p><p><br></p></h3><p><img src=\"http://back.1cloud.xyz/uploadImg/1588822281286_image.png\" style=\"max-width: 100%;\"></p><p><br></p><h3>5. 重新登录系统后可以看到菜单栏发生变化（注：必须重新登录，因为所有菜单页面是在用户登录时后端返回的）&nbsp; &nbsp;</h3><p>&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</p><p><img src=\"http://back.1cloud.xyz/uploadImg/1588822533011_image.png\" style=\"max-width: 100%;\"></p><p><br></p><h3><p>6. 修改你的List文件，把请求路径修改为新的接口（接口格式参考：<a href=\"http://back.1cloud.xyz/article/detail?id=5\" target=\"_blank\">接口文档</a>）；</p><p><br></p></h3><p><img src=\"http://back.1cloud.xyz/uploadImg/1588822834456_image.png\" style=\"max-width: 100%;\"></p><p><span style=\"color: rgba(0, 0, 0, 0.85);\"><br></span></p><h3>7.接口成功返回后，我们需要修改表格显示的字段：&nbsp;<span style=\"color: rgba(0, 0, 0, 0.65); font-size: 14px;\">&nbsp;</span><span style=\"color: rgba(0, 0, 0, 0.85);\">&nbsp;</span></h3><p><br></p><p><img src=\"http://back.1cloud.xyz/uploadImg/1588823478073_image.png\" style=\"max-width: 100%;\"></p><p><br></p><h3>8. 修改表格的数据源：&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;<br></h3><p><br></p><p><img src=\"http://back.1cloud.xyz/uploadImg/1588823708217_image.png\" style=\"max-width: 100%;\"></p><p><br></p><h3>9. 修改查询条件。</h3><p><img src=\"http://back.1cloud.xyz/uploadImg/1589859700207_image.png\" style=\"max-width:100%;\"><br></p><h3>10.修改删除接口路径。</h3><h3>11.修改新增、修改、详情页面。</h3><h3>12.列表页完成。&nbsp;<br></h3>', '2020-04-24 00:00:00', '2020-05-19 03:41:45');
INSERT INTO `article` VALUES ('5', '接口文档——基础列表页', '1', '接口文档', '<h2>基础列表页</h2><h3>1. 基础列表</h3><p>请求方法：POST</p><p>请求路径：/empty-item/demo/list</p><p>请求参数：createdAt（Array），remark，type（0：全部，1：banner，2：海报）</p><p>返回结果：</p><p><img src=\"http://back.1cloud.xyz/uploadImg/1588832231454_image.png\" style=\"max-width:100%;\"><br></p><h3>2. 详情</h3><p>请求方法：GET</p><p>请求路径：/empty-item/demo/detail</p><p>请求参数：id</p><p>返回结果：</p><p><img src=\"http://back.1cloud.xyz/uploadImg/1588832943047_image.png\" style=\"max-width:100%;\"><br></p><h3>3. 新增/修改</h3><p>请求方法：POST</p><p>请求路径：/empty-item/demo/saveOrUpdate</p><p>请求参数：id（修改时必填），type（必填，0：全部，1：banner，2：海报），url（必填，图片相对路径）,remark，</p><p>返回结果：</p><p><img src=\"http://back.1cloud.xyz/uploadImg/1588833256434_image.png\" style=\"max-width:100%;\"><br></p><h3>4. 上传图片</h3><p>请求方法：POST</p><p>请求路径：/empty-item/api/uploadImg</p><p>请求参数：file（Form Data）</p><p>返回结果：</p><p><img src=\"http://back.1cloud.xyz/uploadImg/1588833553012_image.png\" style=\"max-width:100%;\"><br></p><h3>5. 删除</h3><p>请求方法：POST</p><p>请求路径：/empty-item/demo/delete</p><p>请求参数：id</p><p>返回结果：</p><p><img src=\"http://back.1cloud.xyz/uploadImg/1588833725493_image.png\" style=\"max-width:100%;\"><br></p>', '2020-05-07 06:10:11', '2020-05-07 06:42:15');
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=82 DEFAULT CHARSET=utf8 COMMENT='系统菜单表';
...
INSERT INTO `sys_menu` VALUES ('54', '新增用户', 'addUser', '0', null, null, '1', '2020-04-26 05:23:19', '2020-04-26 05:23:19', null, 'pageAuth', '46', null, '/empty-item/sysUser/saveOrUpdateUser');
INSERT INTO `sys_menu` VALUES ('55', '查看用户列表', 'seeUser', '0', null, null, '1', '2020-04-26 06:31:43', '2020-04-26 06:31:43', null, 'pageAuth', '46', null, '/empty-item/sysUser/userList');
...
INSERT INTO `sys_menu` VALUES ('78', '新增按钮', 'addAuthList', '0', null, null, '1', '2020-05-18 08:32:47', '2020-05-18 08:32:47', '新增按钮-权限可控的列表页', 'pageAuth', '77', null, '/empty-item/demo/saveOrUpdate');
INSERT INTO `sys_menu` VALUES ('79', '编辑按钮', 'editAuthList', '0', null, null, '1', '2020-05-18 08:33:25', '2020-05-18 08:33:25', '编辑按钮-权限可控的列表页', 'pageAuth', '77', null, '/empty-item/demo/saveOrUpdate');
INSERT INTO `sys_menu` VALUES ('80', '删除按钮', 'deleteAuthList', '0', null, null, '1', '2020-05-18 08:34:24', '2020-05-18 08:34:24', '删除按钮-权限可控的列表页', 'pageAuth', '77', null, '/empty-item/demo/delete');
...
CREATE TABLE `sys_user` (
  ...
  `deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=58 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='用户信息';
